				...
				<div class="row clearfix">
					...
					<div class="body-nest">
						<div class="alert alert-warning text-center" role="alert">
							<h4 color="red">数据安全管理</h4>
						</div>
						<div class="well row">
							<div class="panel panel-default">
								<div class="panel-heading">安全管理</div>
								<div class="panel-body">
									<div class="text-center"><h4><b>统计</b></h4></div>
									<div class="row clearfix col-md-5" style="margin-right:10px; margin-left:10px;">
										<ul class="list-group well">
											<li class="list-group-item active">
												<span class="badge">数量</span>
												名称
											</li>
								...
								<div class="panel-footer">
									<b style="margin:15px; border: 1px dotted #2ca7b2;">
										<b style="margin:5px; border: 1px dotted #cc3030;">备份全部数据</b>
									</b>
									<button type="button" class="btn btn-warning">
										<span class="glyphicon glyphicon-hdd"></span> 备份
									</button>
								...
								<div class="panel-footer">
									<b style="margin:15px; border: 1px dotted #2ca7b2;">
										<b style="margin:5px; border: 1px dotted #cc3030;">整理数据</b>
									</b>
									<button type="button" class="btn btn-primary">
										<span class="glyphicon glyphicon-compressed"></span> 整理
									</button>
								</div>
							</div>
						</div>
