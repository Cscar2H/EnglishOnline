			...
			<div class="paper-wrap bevel tlbr" style="min-height:700px!important; color:#000;">
				<div class="row clearfix">
					<div class="text-right">
						...
						主页 <span class="glyphicon glyphicon-arrow-right"></span>留言版
						<hr style="border:1px solid #dfd9d9;">
					</div>
					<div class="body-nest">
						<div style="border-bottom: 1px dotted #c32c2c">
							<a href="WriteMessageWeb" style="color:#f341d1!important;">
								<h5 class="glyphicon glyphicon-edit pull-right">留言</h5>
							</a>
							<h4><b>留言版 @_@</b></h4>
						</div>
						<div style="margin-top: 3px; border-top: 1px dotted #4ca7b2; border-bottom: 1px dotted #4ca7b2;">
								<p style="border-bottom: 1px dotted #1b1c20;">
									#1楼：匿名
									<span class="pull-right">时间：2017年8月10日 23:24:45</span>
								</p>
								<h6 class="clearfix">text<br>text<br>text<br>text<br>text<br></h6>
						</div>
						<div style="margin-top: 3px; border-top: 1px dotted #4ca7b2; border-bottom: 1px dotted #4ca7b2;">
								<p style="border-bottom: 1px dotted #1b1c20;">
									#3楼：匿名
