			...
			<div class="paper-wrap bevel tlbr" style="min-height:700px!important; color:#000;">
				<div class="row clearfix">
					<div class="text-right">
						...
						留言版 <span class="glyphicon glyphicon-arrow-right"></span>
						留言
						<hr style="border:1px solid #dfd9d9;">
					</div>
					<div class="well">
						<div class="text-center" style="border-bottom: 1px dotted #f341d1">
							<h4><b>留言 <span class="glyphicon glyphicon-edit"></span></b></h4>
						</div>
						<div class="panel panel-info" style="border:1px solid #000;">
							<div class="panel-heading text-center">
								<input name="Fruit" type="radio" value="0" checked />匿名
								<input name="Fruit" type="radio" value="1" />用户名
							</div>
							<div class="panel-body" align="center">
								<textarea maxlength="100" class="panel" style="resize:none;margin: 0px; width: 100%; height: 100px;" placeholder="输入需要留言的内容（限100词）···"></textarea>
							</div>
							<div class="text-center" style="margin: 5px; border: 1px dotted #f341d1">
								<span class="sapnDow" style="margin: 5px; border-left: 1px dotted #f341d1; border-right: 1px dotted #f341d1;">~---+_+---~</span>
							</div>
							<div class="bg-success" >
								<div>
										<button type="button" class="btn btn-danger">
											<a href="MessageWeb" style="color:#FFF;">
												返回 <span class="glyphicon glyphicon-share-alt"></span>
											</a>
										</button>
										<button type="button" class="btn btn-info">
											提交 <span class="glyphicon glyphicon-upload"></span>
										</button>
								</div>
							</div>
						</div>
