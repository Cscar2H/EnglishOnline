			...
			<div class="paper-wrap bevel tlbr" style="min-height:700px!important; color:#000;">
				<div class="row clearfix">
					<div class="text-right">
						...
						主页 <span class="glyphicon glyphicon-arrow-right"></span>翻译
						<hr style="border:1px solid #dfd9d9;">
					</div>
					<div class="panel panel-info" style="border:1px solid #000;">
						<div class="panel-heading text-center">翻译</div>
						<div class="panel-body" align="center">
							<textarea class="panel" style="resize:none;margin: 0px; width: 100%; height: 100px;" placeholder="输入需要翻译的内容（限200词）···"  onblur="checkWord(this.value,'TextareaReturnResult','<?php echo site_url('/TranWord/');?>');"></textarea>
						</div>
						...
						<div class="bg-success well" style="min-height: 150px">
							<div id="TextareaReturnResult" style="color:#000!important;">
								输出翻译结果
							</div>
						</div>
					</div>
