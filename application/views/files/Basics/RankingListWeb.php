			...
			<div class="paper-wrap bevel tlbr" style="height:700px!important; color:#000;">
				<div class="row clearfix">
					<div class="text-right">
						...
						主页 <span class="glyphicon glyphicon-arrow-right"></span>排行榜
						<hr style="border:1px solid #dfd9d9;">
					</div>
					<div class="well text-center" style="height:10px!important;">
						<span style="font-size:18px; color:#e02bd7;"><b>排行榜</b></span>
					</div>
					<div class="body-nest">
					<ul class="list-group">
