			...
			<div class="paper-wrap bevel tlbr" style="min-height:700px!important; color:#000;">
				<div class="row clearfix">
					...
					<div class="alert alert-success text-center" role="alert">
						<sapn  style="font-size:16px;">文章</sapn>
					</div>
					<div class="well" style="margin:0; color:#000;">
						<table class="table table-hover" style="margin:0; color:#000;">
						  <tr style="border-bottom:1px solid #dfd9d9;">
						  	<td class="col-md-1 column" style="border-right:1px solid #dfd9d9;">序号</td>
						  	<td style="border-right:1px solid #dfd9d9;">标题</td>
						  	<td class="col-md-3 column">阅读量&时间</td>
						  </tr>
						  <tr style="border-bottom:1px solid #dfd9d9;">
						  	<td class="col-md-1 column" style="border-right:1px solid #dfd9d9;">1</td>
						  	<td style="border-right:1px solid #dfd9d9;">
						  		<a href="ReadArticleWeb" style="color:#7f00ff;">文章1····················</a>
						  	</td>
						  ...
						  <tr style="border-bottom:1px solid #dfd9d9;">
						  	...
						  	<td style="border-right:1px solid #dfd9d9;">
						  		<a href="ReadArticleWeb" style="color:#7f00ff;">文章2····················</a>
						  	</td>
						  	<td class="col-md-4 column">
						  		<span class="glyphicon glyphicon-eye-open">阅读(0)</span>
						  		<span class="glyphicon glyphicon-calendar">2017年8月9日</span>
						  ...
						  <tr style="border-bottom:1px solid #dfd9d9;">
						  	...
						  	<td style="border-right:1px solid #dfd9d9;">
						  		<a href="ReadArticleWeb" style="color:#7f00ff;">文章3····················</a>
						  	</td>
						  	<td class="col-md-4 column">
						  		<span class="glyphicon glyphicon-eye-open">阅读(0)</span>
						  		<span class="glyphicon glyphicon-calendar">2017年8月9日</span>
						  ...
						  <tr style="border-bottom:1px solid #dfd9d9;">
						  	...
						  	<td style="border-right:1px solid #dfd9d9;">
						  		<a href="ReadArticleWeb" style="color:#7f00ff;">文章4····················</a>
						  	</td>
						  	<td class="col-md-4 column">
						  		<span class="glyphicon glyphicon-eye-open">阅读(0)</span>
						  		<span class="glyphicon glyphicon-calendar">2017年8月9日</span>
						  	...
						  	<td style="border-right:1px solid #dfd9d9;">
						  		<a href="ReadArticleWeb" style="color:#7f00ff;">文章5····················</a>
						  	</td>
						  	<td class="col-md-4 column">
						  		<span class="glyphicon glyphicon-eye-open">阅读(0)</span>
						  		<span class="glyphicon glyphicon-calendar">2017年8月9日</span>
